...
public class TrackUserLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (locationTrack.canGetLocation()) {
            ...
            Toast.makeText(this,"Your distance to admin location is "+findDistanceBetween(lat,lng,mLat,mLon)+"m",Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(TrackUserLocation.this)
                .setMessage(message)
